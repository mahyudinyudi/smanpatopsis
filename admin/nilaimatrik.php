...
<div class="form-group">
							...
							<div class="col-lg-4">
								...
								$query=mysqli_query($con,"select * from alternatif");
								while($row=mysqli_fetch_assoc($query)){
								?>
								
									<option value="<?php echo $row['id_alternatif'] ?>"><?php echo $row['id_alternatif']." | ".$row['nm_alternatif'] ?></option>
								<?php
								}
								?>
								</select>
...
<div class="form-group">
								<?php
								$i=1;
								$alt=mysqli_query($con,"select * from kriteria");
						//hitung jml kriteria		
